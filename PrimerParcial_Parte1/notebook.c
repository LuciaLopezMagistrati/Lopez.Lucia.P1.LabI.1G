...
int mostrarNotebooks(eNotebook lnotebook[], int tamN, eMarca lMarcas[], int tamMa, eTipo lTipos[], int tamT)
{
    int retorno = 0;
    int flag = 1;
    if(lnotebook != NULL && tamN > 0 && lMarcas != NULL && tamMa > 0 &&  lTipos != NULL && tamT > 0)
    {
        //system("cls");
        printf("\n    ****Lista de notebooks ****\n");
        printf("---------------------------------------------------------------------------------------------\n");
        ...
        for(int i= 0; i<tamN; i++)
        {
            if(!lnotebook[i].isEmpty)
            {
                ...
                mostrarNotebook(lnotebook[i], lMarcas, tamMa, lTipos,tamT);
                flag = 0;
            }
        }
...
int modificarNotebook(eNotebook lnotebook[], int tamN, eMarca lMarcas[], int tamMa, eTipo lTipos[], int tamT)
{
    ...
    if(lnotebook != NULL && tamN > 0 && lMarcas != NULL && tamMa > 0 && lTipos != NULL && tamT > 0)
    {
        ...
        mostrarNotebooks(lnotebook, tamN,lMarcas, tamMa,  lTipos,tamT);
        ...
        if(!utn_getNumeroEntero(&id, "Ingrese el id de la notebook a modificar: ", "\nError.",2000, 4000, 3))
        {
            ...
            else
            {
                ...
                mostrarNotebook(lnotebook[indice], lMarcas, tamMa, lTipos,tamT);
...
int bajaNotebook(eNotebook lNotebooks[], int tamN, eMarca lMarcas[], int tamMa, eTipo lTipos[], int tamT)
{
    ...
    if(lNotebooks != NULL && tamN > 0 && lMarcas != NULL && tamMa > 0 && lTipos != NULL && tamT > 0)
    {
        ...
        mostrarNotebooks(lNotebooks, tamN,lMarcas, tamMa,  lTipos,tamT);
        ...
        if(!utn_getNumeroEntero(&id, "Ingrese el id de la notebook a dar de baja: ", "\nError.",2000, 4000, 3))
        {
            ...
            else
            {
                ...
                mostrarNotebook(lNotebooks[indice], lMarcas, tamMa, lTipos,tamT);
...
int listarNBCriterios(eNotebook aNotebooks[], int tamN, eMarca aMarcas[], int tamMa, eTipo aTipos[], int tamT)
{
    ...
    if(aNotebooks != NULL && tamN >0 )
    {
        ...
        mostrarNotebooks(aNotebooks, tamN, aMarcas, tamMa, aTipos, tamT);
