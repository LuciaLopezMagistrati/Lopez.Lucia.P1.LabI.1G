...
int main()
{
    ...
    hardcodearNotebooks(listaNotebooks,TAM_NOTEBOOKS,10, &nextId);
    ...
    do
    {

        {
            ...
            case 'A':
                ...
                if(altaNotebook(listaNotebooks,TAM_NOTEBOOKS,listaMarcas, TAM_MARCAS, listaTipos, TAM_TIPOS, &nextId)==1)
                {
                    printf("Alta exitosa\n\n");
                }
                else
            ...
            case 'B':
                ...
                {
                    if(modificarNotebook(listaNotebooks,TAM_NOTEBOOKS,listaMarcas, TAM_MARCAS, listaTipos, TAM_TIPOS)==1)
                    {
            ...
            case 'C':
                if(validaNotebookActiva(listaNotebooks, TAM_NOTEBOOKS))
                {
                    if(bajaNotebook(listaNotebooks,TAM_NOTEBOOKS,listaMarcas, TAM_MARCAS, listaTipos, TAM_TIPOS)==1)
                    {
                        printf("Baja exitosa\n\n");
                    }
                    else
            ...
            case 'D':
                if(validaNotebookActiva(listaNotebooks, TAM_NOTEBOOKS))
                {
                    listarNBCriterios(listaNotebooks,TAM_NOTEBOOKS,listaMarcas, TAM_MARCAS, listaTipos, TAM_TIPOS) ;
                }
                else
                {
